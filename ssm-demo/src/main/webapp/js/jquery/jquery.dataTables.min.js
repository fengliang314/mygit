...
(function(h) { 
	...
	m.defaults = {
		...
		oLanguage: {
			...
			sEmptyTable: "数据加载失败，请重试。",
			sInfo: "总共_PAGES_页,共_MAX_条记录",
			sInfoEmpty: "0条记录",
			sInfoFiltered: "",
			sInfoPostFix: "",
			sDecimal: "",
			sThousands: ",",
			sLengthMenu: "行数： _MENU_ 条",
			sLoadingRecords: "正在加载数据...",
			sProcessing: "正在加载数据...",
			sSearch: '<span style="right:-250px" class="glyphicon glyphicon-search searchspan"></span>',
